...
menuDiv.append(engButton, rusButton);
...
const divInit = () => {
  ...
  const header = document.createElement('h2', 'float-right');
  header.classList.add('display-6', 'text-light');
  ...
  divElement.append(dropDiv, header, form);
  return divElement;
};
