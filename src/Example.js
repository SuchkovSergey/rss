...
// const text = '<div class="jumbotron"><h1 class="display-4">RSS
// </h1><p class="lead">Some information here</p><form><div class="form-group">
...
export default class Example {
  ...
  init() {
    this.element.textContent = 'heeeeeey';
  }
}
